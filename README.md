...
> ETL Builder: Visual ETL pipeline builder with connectors and transformation DSL
...
## 🏗️ Architecture
Three-tier architecture: Python, Airflow backend, native frontend, PostgreSQL database. Containerized with Docker.
...
git clone https://github.com/elitsuri/etl-builder
cd etl-builder
