...
app = FastAPI(
    title="etl-builder",
    description="ETL Builder: Visual ETL pipeline builder with connectors and transformation DSL",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "etl-builder"}
